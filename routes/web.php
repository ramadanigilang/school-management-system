...
Route::prefix('users')->group(function () {
    ...
    Route::get('/ddelete/{id}', [UserController::class, 'UserDelete'])->name('users.delete');
});
...
Route::prefix('setups')->group(function () {
    ...
    Route::prefix('students')->group(function () {
        ...
        Route::post('/reg/store', [StudentRegistrationController::class, 'StudentRegStore'])->name('store.student.registration');
